...
<span style="background:yellow">1.&nbsp;API 模式——>可以为函数提供更好且更整洁的接口。</span>
...
<span style="background:yellow">2.&nbsp;初始化模式——>可以在不污染全局命名空间的情况下，使用临时变量以一种更加整洁、结构化的方式初始化以及设置任务。</span>
...
<span style="background:yellow">3.&nbsp;性能模式——>可以加速代码运行</span>
